<footer class="text-center text-white bg-light ">
    ...
    <div class=" py-2 bg-primary">
        ...
        <a
            ...
            ><i class="icon ion-md-call"></i></a>

            <!-- EMAIL -->
            <a
                class="btn btn-link btn-floating btn-lg text-light m-1"
                target="_blank"
                href="mailto:coordinacion.li.fesc@hotmail.com"
                role="button"
                data-mdb-ripple-color="dark"
            ><i class="icon ion-md-mail"></i></a>

            <!-- Facebook -->
            <a
                class="btn btn-link btn-floating btn-lg text-light m-1"
                target="_blank"
                href="https://www.facebook.com/Coordinaci%C3%B3n-Lic-Inform%C3%A1tica-FES-C-274154029687087/"
                role="button"
            ...
            <a
                class="btn btn-link btn-floating btn-lg text-light m-1"
                target="_blank"
                href="https://www.youtube.com/channel/UCORpUwvwlIiv8Oacp9Xt8RA"
                role="button"
                data-mdb-ripple-color="grey"
            ><i class="icon ion-logo-youtube"></i></a>
            <!-- MAPS -->
            <a
                class="btn btn-link btn-floating btn-lg text-light m-1"
                target="_blank"
                href="https://goo.gl/maps/EnyQwHZzGoDx4kXz9"
                role="button"
                data-mdb-ripple-color="dark"
            ><i class="icon ion-md-map"></i></a>
