...
<div class="modal fade" id="editAlumno" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-lg-12 p-3">
                        <!-- INICIA FORMULARIO-->
                        <form class="user needs-validation" id="frmEdit" role="form" autocomplete="off">
                            <div class="form-group row">
                                <div class="col-sm-4 mb-3">
                                    <input type="text" class="form-control form-control-user"  name="nombreAlumno" id="nombreAlumno" placeholder="Nombre(s)">
                                </div>
                                <div class="col-sm-4 mb-3">
                                    <input type="text" class="form-control form-control-user" name="appAlumno"  id="appAlumno" placeholder="Apellido Paterno">
                                </div>
                                <div class="col-sm-4 mb-3">
                                    <input type="text" class="form-control form-control-user" name="apmAlumno"  id="apmAlumno" placeholder="Apellido Materno">
                                </div>
                            </div>
                            <div class="form-group">
                                <input type="email" class="form-control form-control-user"  name="correoAlumno" id="correoAlumno" placeholder="Correo Electrónico">
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-12 mb-3 mb-sm-0">
                                    <input type="tel" class="form-control form-control-user" name="telAlumno"  id="telAlumno" placeholder="Teléfono de Contacto">
                                </div>
                            </div>
                            <hr>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4 mb-3 mb-sm-0">
                                    <label for="universidades">Universidad/Escuela:</label>
                                </div>
                                <div class="col-sm-8">
