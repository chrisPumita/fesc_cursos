...
if (isset($_POST['id'])||isset($_POST['status'])||isset($_POST['type'])){
    ...
    switch ($type)
    {
        ...
        case 1:
            ...
            $mje = updateEstatusAlumno($id,$status) ? "Se actualizo el estatus": "Error al actualizar el estatus";
        break;
        case 2:
        ...
        //actualizo a admin
            ...
            $mje = cambiaEstatusAdmin($id,$status) ? "Se actualizó el estatus" : "Error al actulizar el estatus";
        break;
    }
    echo $mje;
}